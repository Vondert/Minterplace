    ...
    return(
        <div>
            ...
            <div>
                ...
                <input className={styles.input} maxLength={50} type="text" name="name" placeholder="'CryptoRex'" autoComplete='off' value={name} onChange={(e) => handleTextBoxChange(e, "name")}/>
                <label className={styles.smallLabel}>Symbol</label>
                <input className={styles.input} maxLength={20} type="text" name="symbol" placeholder="'CRX'" autoComplete='off' value={symbol} onChange={(e) => handleTextBoxChange(e, "symbol")}/>
